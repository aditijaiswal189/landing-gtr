...
const ageRanges = ["18-25 years", "26-35 years", "36-45 years", "45+ years"];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <input
            type="hidden"
            name="xnQsjsdp"
            value="9e7c89c240ebe2b7b463bdcd8d85480042042015c8c91108a7d4865a643ed0d4"
          />
          <input type="hidden" name="zc_gad" id="zc_gad" value="" />
          <input
            type="hidden"
            name="xmIwtLD"
            value="770f5b563b2ed4146eb3920efb2cf9faeeaffc51274d9e46fb3fab86dd6ad8a4b101e0358caf3877df53ca42fc514dc2"
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                readOnly
                value={currentDateTime}
                className="w-full px-4 py-3 border bg-gray-100 text-gray-600 rounded-lg"
              />
            </div>
